...
export const createCustomer = async (req, res) => {
    try {
        const { email, name, description, phone, address_line1, address_line2, city, state, postal_code, country } = req.body;
        ...
        return errorResponse(res, 500, "Failed to create customer", { error: error.message });
    }
};